...
.PHONY: debug
debug: ${BIN}/dmrg_debug ${BIN}/quick_test_debug ${BIN}/time_test_debug ${BIN}/ladder_test_debug
...
${BIN}/ladder_test_debug: ${TEST}/ladder_test.c ${objsD}
	${CC} ${INCDIRS} ${CCOPTSD} ${objsD} ${TEST}/ladder_test.c ${LIB}  -o ${BIN}/ladder_test_debug
